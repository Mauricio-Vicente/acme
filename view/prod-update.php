        ...
        <main>
            <div id="addCat">
                ...
                <!--catList End-->
                    ...
                    <input type="text" name="invImage" id="invName" required <?php if(isset($invImage)){ echo "value='$invImage'"; } elseif(isset($prodInfo['invImage'])) {echo "value='$prodInfo[invImage]'"; }?>><br>
                    ...
                    <input type="text" name="invStock" id="invPrice" required <?php if(isset($invStock)){ echo "value='$invStock'"; } elseif(isset($prodInfo['invStock'])) {echo "value='$prodInfo[invStock]'"; }?>><br>
                    ...
                    <input type="text" name="categoryId" id="categoryId" required <?php if(isset($categoryId)){ echo "value='$categoryId'"; } elseif(isset($prodInfo['categoryId'])) {echo "value='$prodInfo[categoryId]'"; }?>><br>
