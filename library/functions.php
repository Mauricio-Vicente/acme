...
function buildProductsDisplay($products) {
    ...
    foreach ($products as $product) {
        $pd .= '<li>';
        $pd .= '<a href="../products/?action=detail&id=' . $product['invId'] . '">';
...
//Build a Function to Display Products Details
function buildProductsDetails($productInfo) {
    $pd = "<h2>$productInfo[invName] </h2>";
    ...
    $pd .= "</ul>";
    $pd .= "<p><span>Descricption:  </span>$productInfo[invDescription]</p>";
